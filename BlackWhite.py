...
def blackwhite_image(input_folder, output_folder, base_filename='Bayer'):
    # 替换为你的FITS文件路径
    ...
    # 保存FITS文件
    save_fits_rgb(equalized_image, save_fits_path)
    print(f"Saved Bayer sequence result as FITS with black and white channels to {save_fits_path}")
